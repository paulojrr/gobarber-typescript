...
appointmentsRouter.get('/', function (_, response) { return __awaiter(void 0, void 0, void 0, function () {
...
appointmentsRouter.post('/', function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, provider, date, parsedDate, createAppointment, appointment, err_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                _a = request.body, provider = _a.provider, date = _a.date;
